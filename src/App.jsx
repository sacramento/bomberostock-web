...
{/* Botón: Escanear QR con cámara trasera (full screen, sin selector) */}
<button
  onClick={async () => {
    ...
    script.onload = () => {
      ...
      // Contenedor del escáner (grande y centrado)
      ...
      // Botón de cancelar grande y claro
      ...
      // Iniciar escáner con configuración óptima
      try {
        window.html5QrcodeScanner = new Html5QrcodeScanner(
          ...
          false // ⚠️ Oculta el selector de cámara
        );
        ...
        window.html5QrcodeScanner.render(
          ...
          (errorMessage) => {
            // Opcional: ver errores en consola
