...
function App() {
  ...
  <div className="min-h-screen">
    ...
    <div className="container mx-auto p-4">
      {/* Botón de volver si hay elemento */}
      {element && (
        <button
          onClick={() => setElement(null)}
          style={{ color: 'blue', marginBottom: '16px', cursor: 'pointer' }}
        >
          ← Volver
        </button>
      )}

      {/* Vista de búsqueda (si no hay elemento seleccionado) */}
      {!element ? (
        <div>
          ...
          {(user.role === 'operador' || user.role === 'admin') && (
            <div style={{ marginTop: '24px', padding: '16px', border: '1px solid #ccc', borderRadius: '8px' }}>
              ...
              <button
                onClick={() => alert('Próximamente: Editar ubicación de MAT-001')}
                style={{
                  display: 'block',
                  width: '100%',
                  padding: '10px',
              ...
              <button
                onClick={() => alert('Próximamente: Dar de baja MAT-001')}
                style={{
                  display: 'block',
                  width: '100%',
                  padding: '10px',
